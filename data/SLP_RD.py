...
def getImg_dsPM(dsFd=r'C:\Users\lykiu\OneDrive\Desktop\340w\code\danalab', idx_subj=1, modality='IR', cov='uncover',
                idx_frm=1):
	'''
...
def genPTr_dict(subj_li, mod_li, dsFd=r'C:\Users\lykiu\OneDrive\Desktop\340w\code\danalab'):
	'''
