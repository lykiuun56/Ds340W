'''
coming with A2J.  Add dynamic channel to it.
Resnet one stride 2 is missing. Seems to be modified by A2J group
'''
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_ch=3, num_classes=1000, zero_init_residual=False):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0])        # one stride 2 missing here
