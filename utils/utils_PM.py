...
def getPth(dsFd=r'C:\Users\lykiu\OneDrive\Desktop\340w\code\danalab',idx_subj=1, modality='IR', cov='uncover', idx_frm=1):
...
def getImg_dsPM(dsFd=r'C:\Users\lykiu\OneDrive\Desktop\340w\code\danalab',idx_subj=1, modality='IR', cov='uncover', idx_frm=1):
    '''
    directly get image
    :param dsFd:
    :param idx_subj:
