...
def parseArgs(if_redef=True):
	...
	# -- env settings
	parser.add_argument('--ds_fd', default=r'C:\Users\lykiu\OneDrive\Desktop\340w\code',
...
def aug_opts(opts):
	...
	opts.SLP_fd = os.path.join(opts.ds_fd, opts.SLP_set) # SLP folder [danaLab|simLab]
